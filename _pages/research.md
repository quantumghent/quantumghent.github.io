...
<h1> Research </h1>
<p>Research in the QuantumGroup@Ugent is focused on unravelling entanglement patterns in interacting quantum many-body systems.  We are developing the theory of quantum tensor networks, devise novel computational methods for optimizing them, and apply those to problems in condensed matter physics, quantum field theory, atomic physics and quantum computing. In the very near future, we will also run the <a href="../beclab/">first Belgian lab probing a Bose-Einstein Condensate</a>. Explore more below...</p>
</div>
  ...
  <text transform="matrix(1, 0, 0, 1, 868.584, 516.75)">
	...
	<tspan x="-53.58" y="33.75" font-family="HelveticaNeue-Light" font-size="24" fill="#808080">categories</tspan>
      ...
      <div id="text_nonequilibriumquantumphysics" class="panel-collapse collapse" role="tabpanel">
        ...
        <p>Non-equilibrium quantum physics is currently one of the most active areas of research both in theoretical and experimental physics. For one, a quantum computer is the ultimate non-equilibrium system. Second, it in only recently that a comprehensive picture has emerged of the mechanism of thermalization in closed many-body systems, where the complex acts both as system and its own bath. Third, concepts like many-body localization and topological indices for many-body Floquet-type evolution operators are still only partly understood.</p>
